...
from controllers.controller_tela_aluno import ControllerTelaAluno
...
class ControllerTelaLogin:
    ...
    def realizar_login(self):
        ...
        id_usuario, nome, tipo_usuario, partidas_ganhas, partidas_perdidas, pontuacao = resultado

        if tipo_usuario.lower() == "aluno":
            self._abrir_tela_aluno(id_usuario, nome, partidas_ganhas, partidas_perdidas, pontuacao)
        elif tipo_usuario.lower() == "professor":
            self._abrir_tela_professor(nome)
        else:
            self._mostrar_erro("Tipo de usuário desconhecido.")

    def _abrir_tela_aluno(self, id_usuario, nome, partidas_ganhas, partidas_perdidas, pontuacao):
        ...
        self.controller_aluno = ControllerTelaAluno(self.tela_aluno, id_usuario)
        self.tela_aluno.retornar_login.connect(self._voltar_login_aluno)
        self.tela_aluno.show()
        self.tela.close()

    def _abrir_tela_professor(self, nome):
        self.tela_professor = TelaProfessor(nome=nome)
        self.tela_professor.retornar_login.connect(self._voltar_login_professor)
    ...
    def _voltar_login_aluno(self):
        ...
        self.tela = TelaLogin()
        self.controller = ControllerTelaLogin(self.tela)
        self.tela.show()
